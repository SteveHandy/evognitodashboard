...
if (isset($_POST['simpan'])) {
    ...
    if ($nama_gambar != '') {
        ...
        if ($cek_upload['status']) {
            ...
            echo "<script>
                ...
                document.location='admin.php?page=article&judul=Article';
            </script>";
            die;
        }
    }
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt = $koneksi->prepare("UPDATE article 
                                SET 
                                judul =?,
                                isi =?,
                                gambar = ?,
        ...
        //insert data
        $stmt = $koneksi->prepare("INSERT INTO article (judul,isi,gambar,tanggal,username)
                                VALUES (?,?,?,?,?)");
...
if (isset($_POST['hapus'])) {
    ...
    $stmt = $koneksi->prepare("DELETE FROM article WHERE id =?");
